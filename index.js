...
const displayString = `A total of ${totalContributions.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfundedGames} game${unfundedGames !== 1 ? 's' : ''} remain${unfundedGames !== 1 ? '' : 's'} unfunded. We need your help to fund these amazing games!`;
...
// Create a new element for the first game
